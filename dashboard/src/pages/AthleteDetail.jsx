...
export default function AthleteDetail() {
  ...
  <div style={{ marginTop: '1.5rem', padding: '1.5rem', background: `${COLORS.success}10`, border: `1px solid ${COLORS.success}30`, borderRadius: 8, borderLeft: `4px solid ${COLORS.success}` }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.875rem' }}>
